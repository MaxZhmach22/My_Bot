...
{
    public static readonly string[] Greeting = {"привет", "здравствуй", "здравствуйте", "добрый день", "добрый вечер", "доброе утро", "здр"};
    public static readonly string[] Weather = {"погода", "weather", "gjuj"};
